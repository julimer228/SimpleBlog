 ...
 *
 * @author julia
 * Servlet to add new topic to the blog
 */
public class AddTopicServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
             response.sendError(response.SC_BAD_REQUEST, "The title of the topic is invalid!");
        }
...
"        <link href=\"https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital@1&display=swap\" rel=\"stylesheet\">");
            ...
            out.println("<title>New Topic</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<br></br>");
            out.println("<br></br>");
            ...
            out.println("<section>");
            out.println("<center>");
            out.println("<p class=\"center\">The new topic has been added</p>");
